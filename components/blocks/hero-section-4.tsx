            ...
            <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
              <div className="mx-auto max-w-lg text-center lg:ml-0 lg:w-1/2 lg:text-left">
                <h1 className="mt-8 max-w-2xl text-balance text-5xl font-bold md:text-6xl lg:mt-16 xl:text-7xl">
                  We Build Software with Passion
                </h1>
                <p className="mt-8 max-w-2xl text-pretty text-lg">
                  We don&apos;t build for clients. We build for ourselves—and
                  for the world. Our mission is to create products that inspire,
                  empower, and delight millions.
                </p>

                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                  <Button asChild size="lg" className="px-5 text-base">
                    <Link href="#link">
                      <span className="text-nowrap">Our Products</span>
                    </Link>
                  </Button>
                  <Button
                    key={2}
